        ...
        <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          ...
          <ul className="hidden lg:flex col-start-4 col-end-8 text-black-500 justify-center items-center">
            ...
            <LinkScroll
              ...
              <span className="flex bg-blue-500 text-white-500 w-5 h-5 font-extralight items-center justify-center rounded-full absolute bottom-0 right-0">
                {/* Dynamic Cart Item amount goes here */}5
              </span>
            </LinkScroll>
          </ul>
