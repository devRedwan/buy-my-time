...
const CartItem = ({ service }) => {
  ...
  const totalPrice = parseFloat(service?.price * qty).toFixed(2);
  return (
    <div className="cartService__itemWrapper my-5 py-6 border-b border-blue-300 max-w-2xl">
      <div className="cartService__itemDetails">
        <div
          className="cartService__textWrapper rounded-lg bg-no-repeat bg-cover bg-center bg-blend-overlay h-full w-full bg-blue-100 bg-opacity-90 p-2 xs:py-8 sm:py-12 md:py-16 max-w-2xl"
          style={{
